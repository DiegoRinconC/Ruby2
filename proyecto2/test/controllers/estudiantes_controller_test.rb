...
class EstudiantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estudiante" do
    assert_difference('Estudiante.count') do
      post estudiantes_url, params: { estudiante: { document: @estudiante.document, last_name: @estudiante.last_name, name: @estudiante.name } }
    end
  ...
  test "should update estudiante" do
    patch estudiante_url(@estudiante), params: { estudiante: { document: @estudiante.document, last_name: @estudiante.last_name, name: @estudiante.name } }
